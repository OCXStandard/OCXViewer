...
public class SpielApplication extends Application {
    ...
    private void configureBox(VBox root) {
        ...
        var rectangle = new Rectangle(boxBounds.getWidth(),boxBounds.getHeight());
        rectangle.setFill(lg);
        var text = new javafx.scene.text.Text("Click the above 'Slide Down' button to see the top pane content...");
        text.setWrappingWidth(200);
        text.setFont( Font.font("Arial", 22));
        bottomPane.getChildren().addAll( rectangle, text);
        ...
        var text1 = new javafx.scene.text.Text("Click the below 'Slide Up' button to see the bottom pane content...");
        text1.setWrappingWidth(200);
        text1.setFont( Font.font("Arial", 22));
        sp1.getChildren().add(text1);

        topPane = new StackPane();
        var rectangle2 = new Rectangle(boxBounds.getWidth(),boxBounds.getHeight());
        rectangle2.setFill(lg2);
        topPane.getChildren().addAll(rectangle2, sp1);
