...
/**
*  The <code>ThermodynamicTemperatureType</code> complex type
...
*/
// ThermodynamicTemperatureType urn:oasis:names:tc:unitsml:schema:xsd:UnitsMLSchema_lite-0.9.18
//   
// reference type 

@XmlAccessorType(XmlAccessType.PROPERTY)
@XmlType(name = "ThermodynamicTemperatureType", namespace = "urn:oasis:names:tc:unitsml:schema:xsd:UnitsMLSchema_lite-0.9.18")
public abstract class ThermodynamicTemperatureType extends BaseClass
{
    ...
    */
    ...
    // AttributeWrapper{name='symbol', typeName='xsd:token', targetNamespace='', required=false, defaultValue='null', fixedValue='Θ', referencedType='Object'}
    // 
    ...
    * <summary>
    * Symbol of the quantity thermodynamic temperature.</summary>
    */
    ...
    // end the properties serialised to elements
      ...
      public ThermodynamicTemperatureType() {
          try {
