...
/**
 * The 'compartmentPurposeEnum' enumeration.
 */
@XmlType(name = " compartmentPurposeEnum")
@XmlEnum(String.class)
public enum  CompartmentPurposeEnum {
...
;
   ...
   public static CompartmentPurposeEnum parse(String value) {
