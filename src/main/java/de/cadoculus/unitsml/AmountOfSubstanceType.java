...
/**
*  The <code>AmountOfSubstanceType</code> complex type
...
*/
// AmountOfSubstanceType urn:oasis:names:tc:unitsml:schema:xsd:UnitsMLSchema_lite-0.9.18
//   
// reference type 

@XmlAccessorType(XmlAccessType.PROPERTY)
@XmlType(name = "AmountOfSubstanceType", namespace = "urn:oasis:names:tc:unitsml:schema:xsd:UnitsMLSchema_lite-0.9.18")
public abstract class AmountOfSubstanceType extends BaseClass
{
    ...
    */
    ...
    // AttributeWrapper{name='symbol', typeName='xsd:token', targetNamespace='', required=false, defaultValue='null', fixedValue='N', referencedType='Object'}
    // 
    ...
    * <summary>
    * Symbol of the quantity amount of substance.</summary>
    */
