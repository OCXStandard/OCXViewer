...
*/
// Time urn:oasis:names:tc:unitsml:schema:xsd:UnitsMLSchema_lite-0.9.18
// TimeType  
// reference type 

@XmlAccessorType(XmlAccessType.PROPERTY)
@XmlType(name = "Time", namespace = "urn:oasis:names:tc:unitsml:schema:xsd:UnitsMLSchema_lite-0.9.18")
public  class Time extends TimeType
{
