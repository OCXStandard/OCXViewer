...
/**
*  The <code>LuminousIntensityType</code> complex type
...
*/
// LuminousIntensityType urn:oasis:names:tc:unitsml:schema:xsd:UnitsMLSchema_lite-0.9.18
//   
// reference type 

@XmlAccessorType(XmlAccessType.PROPERTY)
@XmlType(name = "LuminousIntensityType", namespace = "urn:oasis:names:tc:unitsml:schema:xsd:UnitsMLSchema_lite-0.9.18")
public abstract class LuminousIntensityType extends BaseClass
{
    ...
    */
    ...
    // AttributeWrapper{name='symbol', typeName='xsd:token', targetNamespace='', required=false, defaultValue='null', fixedValue='J', referencedType='Object'}
    // 
    ...
    * <summary>
    * Symbol of the quantity luminous intensity.</summary>
    */
