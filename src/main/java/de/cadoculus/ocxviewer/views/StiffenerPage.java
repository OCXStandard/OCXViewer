 ...
 */
public class StiffenerPage extends AbstractDataViewSubPage<org.ocx_schema.v310.Stiffener> {
    public static final String NAME = "Stiffener";
    private static final Logger LOG = LogManager.getLogger(StiffenerPage.class);

    public StiffenerPage(org.ocx_schema.v310.Stiffener stiffener, Page parent) {
