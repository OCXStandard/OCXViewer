...
public enum FlagsEnum {
    ...
    HUNGARY(Locale.forLanguageTag("hu"),  "images/flags/HU@2x.png" ),
    ...
    NORWEGIAN( Locale.forLanguageTag("no"),  "images/flags/NO@2x.png" ),
    POLISH(Locale.forLanguageTag("pl"),  "images/flags/PL@2x.png" ),
    PORTUGUESE( Locale.forLanguageTag("pt"),  "images/flags/PT@2x.png" ),
    RUSSIAN(Locale.forLanguageTag("ru"),  "images/flags/RU@2x.png" ),
    SPANISH(Locale.forLanguageTag("es"),  "images/flags/ES@2x.png" ),
    SWEDISH(Locale.forLanguageTag("sv"),  "images/flags/SE@2x.png" ),
