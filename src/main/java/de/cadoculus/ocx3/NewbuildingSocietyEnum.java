...
/**
 * The 'newbuildingSocietyEnum' enumeration.
 */
@XmlType(name = " newbuildingSocietyEnum")
@XmlEnum(String.class)
public enum  NewbuildingSocietyEnum {
...
;
   ...
   public static NewbuildingSocietyEnum parse(String value) {
