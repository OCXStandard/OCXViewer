...
/**
*  The <code>DescriptionBase_T</code> complex type
...
*/
// DescriptionBase_T https://3docx.org/fileadmin//ocx_schema//V300//OCX_Schema.xsd
// IdBase_T  
// reference type 

@XmlAccessorType(XmlAccessType.PROPERTY)
@XmlType(name = "DescriptionBase_T", namespace = "https://3docx.org/fileadmin//ocx_schema//V300//OCX_Schema.xsd")
public abstract class DescriptionBaseT extends IdBaseT
{

    // the properties serialised to attributes

    // AttributeWrapper{name='name', typeName='xs:string', targetNamespace='', required=false, defaultValue='null', fixedValue='null', referencedType='Object'}
    // 
    ...
    * <summary>
    * An optional descriptive or display name.</summary>
    */
