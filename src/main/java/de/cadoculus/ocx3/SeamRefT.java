...
/**
*  The <code>SeamRef_T</code> complex type
...
*/
// SeamRef_T https://3docx.org/fileadmin//ocx_schema//V300//OCX_Schema.xsd
// BoundedRef_T  
// reference type Seam

@XmlAccessorType(XmlAccessType.PROPERTY)
@XmlType(name = "SeamRef_T", namespace = "https://3docx.org/fileadmin//ocx_schema//V300//OCX_Schema.xsd")
public abstract class SeamRefT extends BoundedRefT
{

    // the properties serialised to attributes

    // AttributeWrapper{name='refType', typeName='refType', targetNamespace='https://3docx.org/fileadmin//ocx_schema//V300//OCX_Schema.xsd', required=true, defaultValue='null', fixedValue='ocx:Seam', referencedType='Object'}
