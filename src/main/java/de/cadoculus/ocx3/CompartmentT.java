...
/**
*  The <code>Compartment_T</code> complex type
 * defined in namespace <code>https://3docx.org/fileadmin//ocx_schema//V300//OCX_Schema.xsd</code>.
* 
 * Type definition of the concept of a compartment part of the vessel capacity plan
 * 				representing a closed volume (space) defined by enclosing structure panels.
 *  

*/
// Compartment_T https://3docx.org/fileadmin//ocx_schema//V300//OCX_Schema.xsd
// EntityBase_T  
// reference type 

@XmlAccessorType(XmlAccessType.PROPERTY)
@XmlType(name = "Compartment_T", namespace = "https://3docx.org/fileadmin//ocx_schema//V300//OCX_Schema.xsd")
public abstract class CompartmentT extends EntityBaseT
{
    ...
    */
    ...
    // Property CompartmentFace
    // PropertyWrapper{name='CompartmentFace', typeName='CompartmentFace', docu='null', type=CompartmentFace, minOccurs=1, maxOccurs=100}
    ...
    // https://3docx.org/fileadmin//ocx_schema//V300//OCX_Schema.xsd https://3docx.org/fileadmin//ocx_schema//V300//OCX_Schema.xsd
    // is simple type false
    /* The 'CompartmentFace' property serialised as  XML elemenmt.
    * 
    */

    private List<CompartmentFace> compartmentFaces = new ArrayList<>();

    public List<CompartmentFace> getCompartmentFace() {
        return compartmentFaces;
    }
