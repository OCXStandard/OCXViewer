...
/**
*  The <code>CircumArc3D_T</code> complex type
...
*/
// CircumArc3D_T https://3docx.org/fileadmin//ocx_schema//V300//OCX_Schema.xsd
// Curve3D_T  
// reference type 

@XmlAccessorType(XmlAccessType.PROPERTY)
@XmlType(name = "CircumArc3D_T", namespace = "https://3docx.org/fileadmin//ocx_schema//V300//OCX_Schema.xsd")
public abstract class CircumArc3DT extends Curve3DT
{
    ...
    */
    ...
    // Property IntermediatePoint
    // PropertyWrapper{name='IntermediatePoint', typeName='IntermediatePoint', docu='null', type=IntermediatePoint, minOccurs=1, maxOccurs=1}
    ...
    // https://3docx.org/fileadmin//ocx_schema//V300//OCX_Schema.xsd https://3docx.org/fileadmin//ocx_schema//V300//OCX_Schema.xsd
    // is simple type false
    /* The 'IntermediatePoint' property serialised as  XML elemenmt.
    * 
    */

    @XmlTransient
    public javafx.beans.property.ObjectProperty<IntermediatePoint> IntermediatePoint = new javafx.beans.property.SimpleObjectProperty<IntermediatePoint>();

    @XmlElement(name = "IntermediatePoint", required = true)
    public IntermediatePoint getIntermediatePoint() {
        return this.IntermediatePoint.get();
    }
    public void setIntermediatePoint( IntermediatePoint value) {
        this.IntermediatePoint.set( value);
    }
