...
/**
*  The <code>RectangularHole_T</code> complex type
...
*/
// RectangularHole_T https://3docx.org/fileadmin//ocx_schema//V300//OCX_Schema.xsd
// ParametricHole2D_T  
// reference type 

@XmlAccessorType(XmlAccessType.PROPERTY)
@XmlType(name = "RectangularHole_T", namespace = "https://3docx.org/fileadmin//ocx_schema//V300//OCX_Schema.xsd")
public abstract class RectangularHoleT extends ParametricHole2DT
{
    ...
    */
    ...
    // PropertyWrapper{name='FilletRadius', typeName='FilletRadius', docu='null', type=FilletRadius, minOccurs=0, maxOccurs=1}
    ...
    // https://3docx.org/fileadmin//ocx_schema//V300//OCX_Schema.xsd https://3docx.org/fileadmin//ocx_schema//V300//OCX_Schema.xsd
    // is simple type false
    /* The 'FilletRadius' property serialised as  XML elemenmt.
    * 
    */

    @XmlTransient
    public javafx.beans.property.ObjectProperty<FilletRadius> FilletRadius = new javafx.beans.property.SimpleObjectProperty<FilletRadius>();

    @XmlElement(name = "FilletRadius", required = false)
    public FilletRadius getFilletRadius() {
        return this.FilletRadius.get();
    }
    public void setFilletRadius( FilletRadius value) {
        this.FilletRadius.set( value);
    }
