...
/**
*  The <code>LBarOW_T</code> complex type
...
*/
// LBarOW_T https://3docx.org/fileadmin//ocx_schema//V300//OCX_Schema.xsd
//   
// reference type 

@XmlAccessorType(XmlAccessType.PROPERTY)
@XmlType(name = "LBarOW_T", namespace = "https://3docx.org/fileadmin//ocx_schema//V300//OCX_Schema.xsd")
public abstract class LBarOWT extends BaseClass
{
    ...
    */
    ...
    // Property Overshoot
    // PropertyWrapper{name='Overshoot', typeName='Overshoot', docu='null', type=Overshoot, minOccurs=1, maxOccurs=1}
    ...
    // https://3docx.org/fileadmin//ocx_schema//V300//OCX_Schema.xsd https://3docx.org/fileadmin//ocx_schema//V300//OCX_Schema.xsd
    // is simple type false
    /* The 'Overshoot' property serialised as  XML elemenmt.
    * 
    */

    @XmlTransient
    public javafx.beans.property.ObjectProperty<Overshoot> Overshoot = new javafx.beans.property.SimpleObjectProperty<Overshoot>();

    @XmlElement(name = "Overshoot", required = true)
    public Overshoot getOvershoot() {
        return this.Overshoot.get();
    }
    public void setOvershoot( Overshoot value) {
        this.Overshoot.set( value);
    }
