...
public class ProgressInputStream extends FilterInputStream {
    ...
    public static final String PROGRESS_ATTR_NAME = "progress";
    private final File file;
    private long pos;
    private int progress;
    private final PropertyChangeSupport propChange;
    private long size;
    public final IntegerProperty progressProperty = new SimpleIntegerProperty();
    ...
    private void updateProgress() {
        ...
        if ( np != progress ) {
            ...
            if ( ( progress % 5 ) == 0 ) {
                propChange.firePropertyChange(PROGRESS_ATTR_NAME, ov, progress );
