...
/**
*  The <code>EdgeReinforcementRef_T</code> complex type
...
*/
// EdgeReinforcementRef_T https://3docx.org/fileadmin//ocx_schema//V300//OCX_Schema.xsd
// BoundedRef_T  
// reference type EdgeReinforcement

@XmlAccessorType(XmlAccessType.PROPERTY)
@XmlType(name = "EdgeReinforcementRef_T", namespace = "https://3docx.org/fileadmin//ocx_schema//V300//OCX_Schema.xsd")
public abstract class EdgeReinforcementRefT extends BoundedRefT
{

    // the properties serialised to attributes

    // AttributeWrapper{name='refType', typeName='refType', targetNamespace='https://3docx.org/fileadmin//ocx_schema//V300//OCX_Schema.xsd', required=true, defaultValue='null', fixedValue='ocx:EdgeReinforcement', referencedType='Object'}
