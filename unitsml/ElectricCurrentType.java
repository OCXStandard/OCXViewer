...
/**
*  The <code>ElectricCurrentType</code> complex type
...
*/
// ElectricCurrentType urn:oasis:names:tc:unitsml:schema:xsd:UnitsMLSchema_lite-0.9.18
//   
// reference type 

@XmlAccessorType(XmlAccessType.PROPERTY)
@XmlType(name = "ElectricCurrentType", namespace = "urn:oasis:names:tc:unitsml:schema:xsd:UnitsMLSchema_lite-0.9.18")
public abstract class ElectricCurrentType extends BaseClass
{
    ...
    */
    ...
    // AttributeWrapper{name='symbol', typeName='xsd:token', targetNamespace='', required=false, defaultValue='null', fixedValue='I', referencedType='Object'}
    // 
    ...
    * <summary>
    * Symbol of the quantity electric current.</summary>
    */
