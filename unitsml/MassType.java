...
/**
*  The <code>MassType</code> complex type
...
*/
// MassType urn:oasis:names:tc:unitsml:schema:xsd:UnitsMLSchema_lite-0.9.18
//   
// reference type 

@XmlAccessorType(XmlAccessType.PROPERTY)
@XmlType(name = "MassType", namespace = "urn:oasis:names:tc:unitsml:schema:xsd:UnitsMLSchema_lite-0.9.18")
public abstract class MassType extends BaseClass
{
    ...
    */
    ...
    // AttributeWrapper{name='symbol', typeName='xsd:token', targetNamespace='', required=false, defaultValue='null', fixedValue='M', referencedType='Object'}
    // 
    ...
    * <summary>
    * Symbol of the quantity mass.</summary>
    */
