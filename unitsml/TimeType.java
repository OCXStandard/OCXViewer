...
/**
*  The <code>TimeType</code> complex type
...
*/
// TimeType urn:oasis:names:tc:unitsml:schema:xsd:UnitsMLSchema_lite-0.9.18
//   
// reference type 

@XmlAccessorType(XmlAccessType.PROPERTY)
@XmlType(name = "TimeType", namespace = "urn:oasis:names:tc:unitsml:schema:xsd:UnitsMLSchema_lite-0.9.18")
public abstract class TimeType extends BaseClass
{
    ...
    */
    ...
    // AttributeWrapper{name='symbol', typeName='xsd:token', targetNamespace='', required=false, defaultValue='null', fixedValue='T', referencedType='Object'}
    // 
    ...
    * <summary>
    * Symbol of the quantity time.</summary>
    */
