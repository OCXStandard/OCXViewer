...
public class BoundingBox extends Bounds {
    ...
    public static final BoundingBox DEFAULT_EMPTY_BBOX = new BoundingBox(new Point3d(42.0, 42.0,
                    42.0), new Point3d(-42.0, -42.0, -42.0));


    public Point3d getLower() {
        var retval =new Point3d();
        getLower(retval);
        return retval;
...
//            }
            ...
            throw new IllegalArgumentException("got unsupported Bounds class " + boundsObject + " in constructor");
        }
...
//            }
                ...
                throw new IllegalArgumentException("got unsupported Bounds class " + bounds[i] + " in constructor [}");
            }
        }
        updateBoundsStates();
    }
...
//            }
            ...
            throw new IllegalArgumentException("got unsupported " + boundsObject + " in set(Bounds)");
        }
    ...
    public int hashCode() {
        ...
        return Arrays.hashCode( new double[] {lower.x, lower.y, lower.z, upper.x, upper.y, upper.z} );
...
//            }
            ...
            throw new IllegalArgumentException("got unsupported bounds object " + boundsObject + " in combine");
        }
...
//                }
                ...
                throw new IllegalArgumentException("got unsupported bounds object " + bounds[i] + " in combine []");
            }
        }
...
//        }
            ...
            throw new IllegalArgumentException("got unsupported bounds object " + boundsObject + " in transform");
        }
    }
...
//            return intersect_ptope_abox ( (BoundingPolytope)boundsObject, this );
            ...
            throw new IllegalArgumentException("got unsupported bounds object " + boundsObject + " in intersect");
        }
...
//                }
             ...
             //   throw new IllegalArgumentException(J3dI18N.getString("BoundingBox6"));
                throw new IllegalArgumentException("got unsupported bounds object " + boundsObjects[i] + " in intersect");
            }
...
//                    }
                    ...
                    throw new IllegalArgumentException("got unsupported bounds object " + boundsObjects[i] + " in closestIntersection");
                }
            }
        }
