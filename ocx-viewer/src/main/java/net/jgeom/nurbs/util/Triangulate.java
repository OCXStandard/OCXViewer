...
public class Triangulate {
	...
	public static double EPSILON = Float.MIN_VALUE;
	...
	*/
	...
	public static void main (String[] args)
	{
		...
		for (int i=0; i<points.length; i++)
			points[i] = t.new XYZ( i*4.0, 400.0 * Math.random(), 0.0 );
		...
		int ntri = t.Triangulate( nv, points, triangles );
