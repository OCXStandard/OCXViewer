...
import org.ocx_schema.v3x.Plate;
...
public class PlatesPage extends AbstractDataViewPage implements Page {
    ...
    public PlatesPage() {
        ...
        var tableColumn1 = new TableColumn<org.ocx_schema.v3x.Plate, org.ocx_schema.v3x.Plate>("ID");
        ...
        var tableColumn2 = new TableColumn<org.ocx_schema.v3x.Plate, String>("GUID");
        tableColumn2.setCellValueFactory(
                c -> new SimpleStringProperty(c.getValue().getGUIDRef()));

        var tableColumn3 = new TableColumn<org.ocx_schema.v3x.Plate, String>("Name");
        tableColumn3.setCellValueFactory(
                c -> new SimpleStringProperty(c.getValue().getName()));


        // TODO: better material representation
        var tableColumn4 = new TableColumn<org.ocx_schema.v3x.Plate, String>("Material");
        ...
        var tableColumn5 = new TableColumn<org.ocx_schema.v3x.Plate, String>("Function");
