...
public class PanelPage extends AbstractDataViewSubPage<Panel> {
    ...
    private Tab createPillarsTab() {
        ...
        final ObservableList<org.ocx_schema.v3x.PillarT> entities = FXCollections.observableArrayList();
        final FilteredList<org.ocx_schema.v3x.PillarT> filteredEntities = new FilteredList<>(entities, p -> true);
        ...
        var tableColumn1 = new TableColumn<org.ocx_schema.v3x.PillarT, org.ocx_schema.v3x.PillarT>("ID");
        ...
        var tableColumn2 = new TableColumn<org.ocx_schema.v3x.PillarT, String>("GUID");
        tableColumn2.setCellValueFactory(
                c -> new SimpleStringProperty(c.getValue().getGUIDRef()));

        var tableColumn3 = new TableColumn<org.ocx_schema.v3x.PillarT, String>("Name");
        tableColumn3.setCellValueFactory(
                c -> new SimpleStringProperty(c.getValue().getName()));

        // TODO: better material representation
        var tableColumn4 = new TableColumn<org.ocx_schema.v3x.PillarT, String>("Material");
