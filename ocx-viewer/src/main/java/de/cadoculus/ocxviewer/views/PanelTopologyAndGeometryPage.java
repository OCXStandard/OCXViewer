 ...
 */
public class PanelTopologyAndGeometryPage extends AbstractDataViewSubPage<org.ocx_schema.v3x.Panel> {
    ...
    public PanelTopologyAndGeometryPage(org.ocx_schema.v3x.Panel panel, Page parent) {
