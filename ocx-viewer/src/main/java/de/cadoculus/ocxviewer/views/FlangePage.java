 ...
 */
public class FlangePage extends AbstractDataViewSubPage<org.ocx_schema.v3x.Stiffener> {
    public static final String NAME = "Stiffener";
    private static final Logger LOG = LogManager.getLogger(FlangePage.class);

    public FlangePage(org.ocx_schema.v3x.Stiffener stiffener, Page parent) {
