 ...
 */
public class MaterialPage extends AbstractDataViewSubPage<org.ocx_schema.v3x.Material> {
    public static final String NAME = "Stiffener";
    private static final Logger LOG = LogManager.getLogger(MaterialPage.class);

    public MaterialPage(org.ocx_schema.v3x.Material material, Page parent) {
