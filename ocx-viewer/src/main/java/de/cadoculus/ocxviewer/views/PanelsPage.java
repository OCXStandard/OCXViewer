...
import org.ocx_schema.v3x.Panel;
...
public class PanelsPage extends AbstractDataViewPage implements Page {
    ...
    private final TableView<org.ocx_schema.v3x.Panel> table;
    private final ObservableList<org.ocx_schema.v3x.Panel> panels = FXCollections.observableArrayList();
